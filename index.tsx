...
const worksData = [
  ...
  {
    id: 2,
    title: "Декаративная табличка",
    desc: "Изготовление нестандартных табличек из ПВХ(Фомакс) с использованием высокоточного ЧПУ-фрезера и прямой ултрафиолетовой печати.",
    img: "/tamgdeti.HEIC"
  },
  {
    id: 3,
    title: "Световой короб",
    desc: "Круглый световой короб из молочного акрила с транслюцентной пленкой для равномерного рассеивания света и прямой УФ-печатью.",
    img: "/pezda.jpg"
  },
  {
    id: 4,
    title: "Двусторонний круглый лайтбокс",
...
const Logo = () => (
  <div className="flex items-center gap-2">
    <img src="/logoo.PNG" alt="Logo" className="h-28 w-auto object-contain -ml-4" />
